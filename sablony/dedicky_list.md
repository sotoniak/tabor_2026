...
Touto listinou Ti svěřuji část odkazu, který jsem
budoval třicet let. Tábor je teď i tvůj.


§ 2 — POVINNOST DĚDICE

Jako dědic tábora se zavazuješ:

  ◆ pamatovat tábor po celý život;
  ◆ vrátit se sem znovu, jako táborník nebo vedoucí;
  ◆ chránit přírodu kolem;
  ◆ pomáhat slabším;
  ◆ hledat pravdu, i když je nepříjemná;
  ◆ věřit v to, že každý člověk má své dobré místo,
    i ten, kdo občas zakopne;
  ◆ jednoho dne to předat svým dětem.
...
Tato listina nabývá plné platnosti tvým vlastním
podpisem. Tím přijímáš dědictví.
...
### Krok 1 — Tisk (cca 4–6 týdnů před táborem)
1. Sehnat ozdobný papír A4, krémový nebo zlatavý, **120–160 g** (rozsah cca 60 listů včetně rezervy).
2. Vytisknout **černobíle** s místem pro **rukou napsané jméno**.
3. Volitelně: ozdobit **zlatým akcentem** v rohu (tisk na zlatý papír) nebo **zlatým spreyem na obvod**.

### Krok 2 — Personalizace (cca 1 týden před)
4. **Rukou napsat jméno** každého dítěte na řádek (= seznam dětí).
5. **Pečlivý kaligrafický rukopis** — vedoucí s nejlepším písmem.
...
9. **Zlatá stuha** 30 cm, převázaná uprostřed listu, uvázat **mašlí**.
10. List je **rolovaný** uvnitř.

### Krok 5 — Tubus pro odvoz (volitelné)
11. **Papírový tubus** (cca 35 × 6 cm) s logem tábora — dítě má kam list uložit.
12. Tubus stojí **15 Kč/ks** v papírnictví.
...
| Položka | Počet | Cena |
|---|---|---|
| Papír 120 g ozdobný | 60 ks A4 | 480 Kč |
| Tisk (případně lokálně) | 60 ks | 60 Kč |
| Razítko (jednou) | 1 sada | 350 Kč |
| Pečetní vosk | 1 sada | 200 Kč |
| Stuhy zlaté | 60 × 30 cm | 240 Kč |
| Tubus papírový (volitelně) | 60 ks | 900 Kč (lze vynechat) |
| **CELKEM (bez tubusu)** | | **1 330 Kč** |
| **CELKEM (s tubusem)** | | **2 230 Kč** |
