# 14 — Materiál a rozpočet

Kompletní seznam materiálu pro celotáborovou hru "30 let: Případ ztracené závěti". Rozděleno podle účelu, s odhadem ceny a poznámkou, co lze pořídit z táborových zásob.

---

## A. Týmový materiál (× 6 týmů)

| Položka | Počet | Cena/ks | Cena celkem | Poznámka |
|---|---|---|---|---|
| Týmový deník (A5, kroužková vazba, 80 listů) | 6 | 80 Kč | 480 Kč | Lze nahradit deskami + listy A5 |
| Mapa tábora A2 (prázdný podklad, šedá síť) | 6 | 25 Kč | 150 Kč | Tisk lokálně, lze i ručně |
| Pevné desky A4 s gumičkou (na složku stop) | 6 | 60 Kč | 360 Kč | |
| Šátek týmové barvy (60 × 60 cm) | 6 | 50 Kč | 300 Kč | Odznak týmu |
| Vlajka týmu (cca 50 × 70 cm, látka) | 6 | 120 Kč | 720 Kč | Děti si dotvoří symbol |
| Plastové kartičky podezřelých (10 ks/tým, A6) | 60 | 5 Kč | 300 Kč | Tisk + laminace |
| Vyšetřovací tužka + propiska (2 ks/tým) | 12 | 15 Kč | 180 Kč | |
| Lupa dětská (2 ks/tým) | 12 | 35 Kč | 420 Kč | Pro forenziku |
| Pinzeta plastová (1 ks/tým) | 6 | 10 Kč | 60 Kč | |
| Sáčky se zipem (sada 20 ks/tým) | 6 | 30 Kč | 180 Kč | Na stopy |
| **Mezisoučet týmový** | | | **3 150 Kč** | |

---

## B. Individuální materiál (× 45 dětí)
...
## C. Forenzní stanoviště (viz soubor 10)

| Položka | Počet | Cena/ks | Cena celkem |
|---|---|---|---|
...
## D. Rekvizity zločinu a vyšetřování
...
## F. Táborové noviny (viz soubor 11)

| Položka | Počet | Cena | Poznámka |
|---|---|---|---|
| Tisk novin (A4, černobíle, 1 list = oboustranně) | 11 vydání × 6 ks | 2 Kč | 132 Kč |
| Nástěnka „Detektivní redakce" — pruh kartonu | 1 | 50 Kč | 50 Kč |
| Špendlíky, magnety | sada | 50 Kč | 50 Kč |
| **Mezisoučet noviny** | | | **232 Kč** |

---

## G. Závěrečná slavnost (den 11)
...
| Položka | Cena |
|---|---|
| Náhradní tisky, papíry, popisovače | 300 Kč |
| Lepicí pásky, špagát, gumičky | 150 Kč |
| Baterie (do baterek pro noční hru den 9–10) | 200 Kč |
| Vlajková páska — vymezení místa činu | 100 Kč |
| **Mezisoučet rezerva** | **750 Kč** |
...
## Co se vyrobí během tábora dětmi (= šetří rozpočet)
...
| Termín | Co pořídit |
|---|---|
| 4 týdny předem | Dědické listy (papír + tisk), pamětní mince (objednávka), Kniha 30 let |
